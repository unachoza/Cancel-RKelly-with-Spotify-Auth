...
import 'Pages/HowItWorks/HowItWorks.css';
      ...
      <Carousel showThumbs={false} showStatus={false}>
        <div className="carousel-divs">
          <p className="paragraph">
            Login with your Spotify credentials. This app will display your playlists and filter through each one to
            find any problematic / RKelly Songs.
          </p>
        </div>
        <div className="carousel-divs">
